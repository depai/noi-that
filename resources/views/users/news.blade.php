...
<link rel="alternate" hreflang="en" href="https://giorgiocollection.com/news" />
<link rel="alternate" hreflang="it" href="https://giorgiocollection.com/it/news" />
<link rel="alternate" hreflang="ar" href="https://giorgiocollection.com/ar/node/125" />
<link rel="alternate" hreflang="fr" href="https://giorgiocollection.com/fr/news" />
<link rel="shortcut icon" href="/sites/default/files/favicon.png" type="image/png" />

    <title>News | Giorgio Collection</title>
...
<link rel="stylesheet" media="all" href="/modules/better_exposed_filters/css/better_exposed_filters.css?r8qfr8" />
...
<link rel="stylesheet" media="all" href="/themes/gavias_facdori/compiledcss/template.css?r8qfr8" />
    ...
    <script type="application/json" data-drupal-selector="drupal-settings-json">{"path":{"baseUrl":"\/","scriptPath":null,"pathPrefix":"","currentPath":"node\/125","currentPathIsAdmin":false,"isFront":false,"currentLanguage":"en"},"pluralDelimiter":"\u0003","suppressDeprecationErrors":true,"ajaxPageState":{"libraries":"better_exposed_filters\/auto_submit,better_exposed_filters\/general,core\/drupal.dropbutton,core\/html5shiv,d8_recaptcha_v3\/recaptcha_v3,dropdown_language\/dropdown-language-selector,gavias_content_builder\/gavias_content_builder.assets.frontend,gavias_facdori\/gavias_facdori.skin.default,gavias_facdori\/global-styling,gavias_sliderlayer\/gavias_sliderlayer.assets.frontend,iubenda\/iubenda,iubenda\/iubenda-cookie-solution,system\/base,views\/views.ajax,views\/views.module","theme":"gavias_facdori","theme_token":null},"ajaxTrustedUrl":{"\/events":true},"d8_recaptcha_v3":{"site_key":null,"captcha_selectors":null,"badge_position":null},"iubenda":{"language":"en","site_id":"2299602","policy_id":"86514578","show_gdpr":1,"show_ccpa":1,"country_detection":0,"buttons":{"accept_button":1,"accept_button_text":"Accept","reject_button":1,"customize_button":1},"position":"float-top-center","apply_styles":1},"views":{"ajax_path":"\/views\/ajax","ajaxViews":{"views_dom_id:f292d574023d6caba2dbda62f3544335a7c956c1233b70cd8c4823a190d1d792":{"view_name":"event","view_display_id":"block_2","view_args":"","view_path":"\/node\/125","view_base_path":"events","view_dom_id":"f292d574023d6caba2dbda62f3544335a7c956c1233b70cd8c4823a190d1d792","pager_element":0}}},"user":{"uid":0,"permissionsHash":"07b61d2569f21086087f9a9fd9e90d9fd786a93b691c4af676114de06b24056d"}}</script>
...
<div data-history-node-id="125" role="article" typeof="schema:WebPage" class="node node--type-page node--view-mode-full">
  ...
  <div class="fieldset-wrapper">
            <div id="edit-field-event-category-value"><div class="form-radios form--inline">
        ...
        <input data-drupal-selector="edit-field-event-category-value-all" type="radio" id="edit-field-event-category-value-all" name="field_event_category_value" value="All" checked="checked" class="form-radio" />

        <label for="edit-field-event-category-value-all" class="option">- Any -</label>
      </div>

                    <div class="js-form-item form-item js-form-type-radio form-item-field-event-category-value js-form-item-field-event-category-value">
        <input data-drupal-selector="edit-field-event-category-value-fiere" type="radio" id="edit-field-event-category-value-fiere" name="field_event_category_value" value="Fiere" class="form-radio" />

        <label for="edit-field-event-category-value-fiere" class="option">Fairs</label>
      </div>

                    <div class="js-form-item form-item js-form-type-radio form-item-field-event-category-value js-form-item-field-event-category-value">
        <input data-drupal-selector="edit-field-event-category-value-showroom" type="radio" id="edit-field-event-category-value-showroom" name="field_event_category_value" value="Showroom" class="form-radio" />

        <label for="edit-field-event-category-value-showroom" class="option">Showroom</label>
      </div>

                    <div class="js-form-item form-item js-form-type-radio form-item-field-event-category-value js-form-item-field-event-category-value">
        <input data-drupal-selector="edit-field-event-category-value-news" type="radio" id="edit-field-event-category-value-news" name="field_event_category_value" value="News" class="form-radio" />

        <label for="edit-field-event-category-value-news" class="option">News</label>
      </div>
...
<div class="item-image">
  <a href="/event/oasi-collection-outdoor"><img src="/sites/default/files/styles/square/public/events/header_news_outdoor_1.jpg?itok=vW_LbF_b" alt="Oasi Preview" title="Oasi Preview" typeof="Image" />

</a>
</div>

<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/oasi-collection-outdoor" hreflang="en">PREVIEW - OASI COLLECTION</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/made-you"><img src="/sites/default/files/styles/square/public/events/header_news_madeforyou.jpg?itok=AOChI7ud" alt="giorgio" title="giorgio" typeof="Image" />
...
<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/made-you" hreflang="en">Made For You</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/outstanding-design"><img src="/sites/default/files/styles/square/public/events/header_news_outdesign%20%281%29.jpg?itok=fSfOW1f8" alt="giorgio" title="giorgio" typeof="Image" />
...
<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/outstanding-design" hreflang="en">Outstanding Design</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/heart-your-house"><img src="/sites/default/files/styles/square/public/events/header_news_tables.jpg?itok=fSOG0ALL" alt="giorgio" title="giorgio" typeof="Image" />
...
<div class="item-image">
  <a href="/event/interior-mebel-kiev-2022"><img src="/sites/default/files/styles/square/public/events/header_news_kiev_1.jpg?itok=eS5hu5ty" alt="giorgio" title="giorgio" typeof="Image" />
...
<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/interior-mebel-kiev-2022" hreflang="en">INTERIOR MEBEL - Kiev 2022</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/iconic-armchair"><img src="/sites/default/files/styles/square/public/events/header_news_iconic_0.jpg?itok=ZJ81Gv3T" alt="giorgio" title="giorgio" typeof="Image" />
...
<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/iconic-armchair" hreflang="en">Iconic Armchair</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/teatro-marcello-ancient-history-contemporary-design"><img src="/sites/default/files/styles/square/public/events/header_news_teatro_0.jpg?itok=q75OgaYb" alt="giorgio" title="giorgio" typeof="Image" />
...
<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/teatro-marcello-ancient-history-contemporary-design" hreflang="en">Teatro Marcello - From ancient history to contemporary design</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/sectional-sofa"><img src="/sites/default/files/styles/square/public/events/header_news_2.jpg?itok=yEK9-YGc" alt="giorgio" title="giorgio" typeof="Image" />
...
<div class="item-image">
  <a href="/event/tradition-innovation"><img src="/sites/default/files/styles/square/public/events/header_news_amman_0.jpg?itok=Uy44SABH" alt="giorgio" title="giorgio" typeof="Image" />
...
<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/tradition-innovation" hreflang="en">Tradition &amp; Innovation</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/i-design-awards"><img src="/sites/default/files/styles/square/public/events/header_news_id.jpg?itok=xcapn582" alt="giorgio" title="giorgio" typeof="Image" />
...
<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/i-design-awards" hreflang="en">I-DESIGN AWARDS</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/dining-tables"><img src="/sites/default/files/styles/square/public/events/header_news_1.jpg?itok=VUzVieJE" alt="giorgio" title="giorgio" typeof="Image" />
...
<p class="event-time-home"></p>
<p class="event-category-home">News</p>
<a href="/event/dining-tables" hreflang="en">DINING TABLES</a>
</div></span></div>
          </div>
                  <div class="colspace10 views-col col-lg-3 col-md-3 col-sm-12 col-xs-12" style="width: 25%;">
            <div class="views-field views-field-nothing"><span class="field-content"><div class="event-item-home">
...
<div class="item-image">
  <a href="/event/design-meets-art"><img src="/sites/default/files/styles/square/public/events/header_news_0.jpg?itok=qciJOZ2u" alt="giorgio" title="giorgio" typeof="Image" />
...
<a href="/event/design-meets-art" hreflang="en">Design meets ART</a>
    ...
    <ul class="pager__items js-pager__items">
                                          ...
                                          <a href="?field_event_category_value=All&amp;field_event_category_value_1=All&amp;page=0" title="Current page">
            <span class="visually-hidden">
              Current page
            </span>1</a>
        </li>
              <li class="pager__item">
                                          <a href="?field_event_category_value=All&amp;field_event_category_value_1=All&amp;page=1" title="Go to page 2">
            <span class="visually-hidden">
              Page
            </span>2</a>
        </li>
              <li class="pager__item">
                                          <a href="?field_event_category_value=All&amp;field_event_category_value_1=All&amp;page=2" title="Go to page 3">
            <span class="visually-hidden">
              Page
            </span>3</a>
        </li>
              <li class="pager__item">
                                          <a href="?field_event_category_value=All&amp;field_event_category_value_1=All&amp;page=3" title="Go to page 4">
            <span class="visually-hidden">
              Page
            </span>4</a>
        </li>
              <li class="pager__item">
                                          <a href="?field_event_category_value=All&amp;field_event_category_value_1=All&amp;page=4" title="Go to page 5">
            <span class="visually-hidden">
              Page
            </span>5</a>
        </li>
              <li class="pager__item">
                                          <a href="?field_event_category_value=All&amp;field_event_category_value_1=All&amp;page=5" title="Go to page 6">
            <span class="visually-hidden">
              Page
            </span>6</a>
        </li>
                                      <li class="pager__item pager__item--next">
          <a href="?field_event_category_value=All&amp;field_event_category_value_1=All&amp;page=1" title="Go to next page" rel="next">
            <span class="visually-hidden">Next page</span>
            <span aria-hidden="true">Next ›</span>
          </a>
        </li>
                          <li class="pager__item pager__item--last">
          <a href="?field_event_category_value=All&amp;field_event_category_value_1=All&amp;page=5" title="Go to last page">
