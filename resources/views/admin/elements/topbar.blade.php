        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ route('dashboard') }}">
                ...
                <b class="logo-icon">
                    ...
                    <!-- Dark Logo icon -->
                    <img src="{{ asset('images/icon_logo.png') }}"  class="dark-logo" />
                    <!-- Light Logo icon -->
                    <img src="{{ asset('images/icon_logo.png') }}"  class="light-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                <span class="logo-text">
                     <!-- dark Logo text -->
                     <img src="{{ asset('images/text_logo.png') }}"  class="dark-logo" />
                     <!-- Light Logo text -->
                     <img src="{{ asset('images/text_logo.png') }}" class="light-logo"  />
                </span>
            </a>
            <!-- ============================================================== -->
            <!-- End Logo -->
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark" id="notifications" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-bell font-24"></i>
                        <span class="text-danger number_count_noti" style="font-weight: bold"></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
                        ...
                        <ul class="list-style-none">
                            ...
                            <li>
                                <div class="message-center notifications" id="listPush">
                                    {{--  <!-- Message -->
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                            ...
                            <div class="m-l-10">
                                <h4 class="m-b-0">{{ (Auth::user()) ? Auth::user()->name : '' }}</h4>
                                <p class=" m-b-0">{{ (Auth::user()) ? Auth::user()->email : '' }}</p>
                            </div>
                        </div>
